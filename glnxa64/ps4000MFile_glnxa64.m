...
%perl options:'ps4000Api.i -outfile=ps4000MFile.m -thunkfile=ps4000_thunk_glnxa64.c -header=ps4000Api.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'ps4000_thunk_glnxa64');
...
fcns.thunkname{fcnNum}='uint32int16voidPtrvoidPtruint16Thunk';fcns.name{fcnNum}='ps4000GetTriggerTimeOffset64'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'longPtr', 'enPS4000TimeUnitsPtr', 'uint16'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32int16voidPtrvoidPtruint16PS4000_CHANNELThunk';fcns.name{fcnNum}='ps4000GetTriggerChannelTimeOffset64'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'longPtr', 'enPS4000TimeUnitsPtr', 'uint16', 'enPS4000Channel'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32int16voidPtrvoidPtruint16uint16Thunk';fcns.name{fcnNum}='ps4000GetValuesTriggerTimeOffsetBulk64'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'longPtr', 'enPS4000TimeUnitsPtr', 'uint16', 'uint16'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32int16voidPtrvoidPtruint16uint16PS4000_CHANNELThunk';fcns.name{fcnNum}='ps4000GetValuesTriggerChannelTimeOffsetBulk64'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'longPtr', 'enPS4000TimeUnitsPtr', 'uint16', 'uint16', 'enPS4000Channel'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32int16voidPtrint32Thunk';fcns.name{fcnNum}='ps4000SetEtsTimeBuffer'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'longPtr', 'int32'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32int16ulongPS4000_HOLDOFF_TYPEThunk';fcns.name{fcnNum}='ps4000HoldOff'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'int16', 'ulong', 'enPs4000HoldOffType'};fcnNum=fcnNum+1;
