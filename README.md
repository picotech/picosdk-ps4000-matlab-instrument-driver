...
* Follow the instructions from our [Linux Software & Drivers for Oscilloscopes and Data Loggers](https://www.picotech.com/downloads/linux) to install the required `libps4000` and `libpswrappers` driver packages.
...
picosdk-ps4000-matlab-instrument-driver is Copyright (C) 2014 - 2017 Pico Technology Ltd. All rights reserved. See [LICENSE.md](LICENSE.md) for license terms. 
